...
/// 提示：本章节的课件文档和说明，可以从课程仓库的文档链接进入到问答区查看
///
class WidgetLifeCycle extends StatefulWidget {
  const WidgetLifeCycle({Key? key}) : super(key: key);
  ///当我们构建一个新的StatefulWidget时，这个会立即掉哦用createState()
  ///并且这个方法必须被覆盖
  @override
...
class _WidgetLifeCycleState extends State<WidgetLifeCycle> {
  ...
  /// 在这个方法中通常会做一些初始化工作，比如 channel 的初始化，监听器的初始化等
  @override
  void initState() {
    print('----initState------');
    super.initState();
  ...
  ///b.如果StatefulWidget依赖于InheritedWidget，那么当当前State所依赖InheritedWidget中的变量改变时会再次调用它
        ...
        child: Column(
          children: [
            TextButton(
              ...
              child: Text('加一', style: TextStyle(fontSize: 26),)
            ),
